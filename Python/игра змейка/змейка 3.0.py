...
while running and not TOUCH and not WIN:
    ...
    for event in pygame.event.get():
        ...
        # Ожидание нажатия кнопки
            ...
            if event.key == pygame.K_w and MOVE != 's':
                MOVE = 'w'
            if event.key == pygame.K_a and MOVE != 'd':
                MOVE = 'a'
            if event.key == pygame.K_s and MOVE != 'w':
                MOVE = 's'
            if event.key == pygame.K_d and MOVE != 'a':
                MOVE = 'd'
